    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('viewer', 'Viewer'), ('evaluator', 'Evaluator'), ('admin', 'Admin'), ('superuser', 'Superuser')], default='viewer', max_length=20)),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(default='', max_length=150)),
                ('last_name', models.CharField(default='', max_length=150)),
                ('role', models.CharField(choices=[('viewer', 'Viewer'), ('evaluator', 'Evaluator')], default='viewer', max_length=20)),
