...
class PatientViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ['first_name', 'last_name', 'national_id', 'phone', 'facility__name']
    ...
    def get_queryset(self):
        ...
        if search_query:
            ...
            logger.info(f'Searching patients with query: {search_query}')
        return queryset
...
class AssessmentViewSet(viewsets.ModelViewSet):
    ...
    pagination_class = StandardResultsSetPagination
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['facility', 'patient', 'evaluator', 'criteria', 'status']
    search_fields = [
        'patient__first_name', 
        'patient__last_name', 
    ...
    ordering_fields = ['assessment_date', 'score', 'scheduled_date', 'created_at']
    permission_classes = [AllowAny]  # Allow any user to access these endpoints
    ...
    def get_queryset(self):
        ...
        if search_query:
            # Log the search query for debugging
            logger.info(f'Searching assessments with query: {search_query}')
        return queryset
...
class AuditViewSet(viewsets.ModelViewSet):
    ...
    search_fields = [
        'facility__name',
        'auditor__username',
        'auditor__display_name',
        'notes',
        'overall_score',
        'status'
    ]
    ordering_fields = ['audit_date', 'overall_score', 'created_at']
    permission_classes = [AllowAny]
    ...
    def get_queryset(self):
        ...
        if search_query:
            # Log the search query for debugging
            logger.info(f'Searching audits with query: {search_query}')
        return queryset
...
class ReportViewSet(viewsets.ModelViewSet):
    ...
    def audit_statistics(self, request):
        ...
        try:
            ...
            facility_stats = [
                {
                    "facilityName": stat['facility__name'] or "Unknown Facility",
                    "count": stat['count']
                }
