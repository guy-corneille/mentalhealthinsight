...
/**
 * Facility Grid View Component
 * 
 * This component displays facilities in a grid layout with cards.
 * It's used on the Facilities page when the grid view mode is selected.
 */
